...
class online_mode(Enemy, Enemy_Gun):
    ...
    def client(self, ip):
        ...
        self.map_choice = self.s.recv(1024).decode()
        
        if self.s.recv(1024).decode() == "True":
            self.lan = True
        else:
            self.lan = False
        ...
        self.online_max_kills = int(self.s.recv(1024).decode())
    ...
    def server(self):
        ...
        self.c.send(str(self.map_choice).encode())    
